"""Generation-quality evaluation of the fast one-shot RAG path."""
...
def test_fast_rag_answer(golden, fast_pipeline, judge):
    """Score the fast-path answer for faithfulness, relevancy, and correctness."""
    result = fast_pipeline.answer(golden["input"])
